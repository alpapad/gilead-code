...
public class User implements Serializable
{
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.domain.IUser#addMessage(net.sf.hibernate4gwt.sample.domain.IMessage)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.domain.IUser#removeMessage(net.sf.hibernate4gwt.sample.domain.IMessage)
	 */
