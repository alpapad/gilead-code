...
public class MessageService implements IMessageService
{
	...
	//-------------------------------------------------------------------------
	/* (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.server.service.IMessageService#loadLastMessage()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.server.service.IMessageService#loadAllMessage(int, int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.server.service.IMessageService#countAllMessage()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.server.service.IMessageService#loadMessageDetails(net.sf.hibernate4gwt.sample.domain.IMessage)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.server.service.IMessageService#saveMessage(net.sf.hibernate4gwt.sample.domain.IMessage)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hibernate4gwt.sample.server.service.IMessageService#deleteMessage(net.sf.hibernate4gwt.sample.domain.IMessage)
	 */
