								...
								implements UserRemote
{
	...
	//
		GwtConfigurationHelper.initGwtStatelessBeanManager(HibernateContext.getSessionFactory());
		
	//	Remove need of CGLIB library and performance improvement for Beanlib
	//
